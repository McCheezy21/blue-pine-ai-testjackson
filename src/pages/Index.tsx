...
const Index = () => {
  return (
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <section id="features" className="relative py-16 bg-gradient-to-b from-white to-gray-50/50">
      ...
      <section id="ai-explanation" className="relative py-16 bg-gradient-to-b from-gray-50/50 to-white">
      ...
      <section id="faq" className="relative py-16 bg-gradient-to-b from-white to-gray-50/50">
        <FAQ />
      </section>
