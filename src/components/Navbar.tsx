      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Button variant="outline" onClick={() => navigate('/demo')} className="ml-2 text-slate-50 py-[23px] mx-[9px] my-0 bg-primary hover:bg-primary/90 px-[28px]">Join Waitlist</Button>
          </div>
        </div>
      </div>
    </nav>;
